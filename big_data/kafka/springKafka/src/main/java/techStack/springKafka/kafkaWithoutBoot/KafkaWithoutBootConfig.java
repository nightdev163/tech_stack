package techStack.springKafka.kafkaWithoutBoot;
...
@Configuration
@EnableKafka
public class KafkaWithoutBootConfig {
    @Bean
    ...
    private Map<String, Object> consumerProps() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.30.96:9092");
    ...
    private Map<String, Object> senderProps() {
        Map<String, Object> props = new HashMap<>();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.30.96:9092");
